...
\cite{RICCI1995541}theory about tuning a diode laser: frequency jumping + how I adjusted temp, current, angle of grating to tune frequency + discuss how the process can be automated.
...
In certain types of crystals it is possible to effect a change in the index of refraction that is proportional to the applied electric field. This is the linear electro-opic effect (also known as the Pockels effect). 

brief introduction on how it works + detailed steps in building it + how to test it 

can discuss relevant RF electornics in the lab as well
can discuss: the triangle-wave generator
