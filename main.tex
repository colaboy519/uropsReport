...
\title{
\includegraphics[width=0.25\textwidth]{nus_logo.png}
\includegraphics[width=0.32\textwidth]{cqt_logo.png}\\
{\LARGE \textbf{Implementation of Electromagnetically-Induced-Transparency Cooling for Yttberbium Ion Chains}}\\
\vspace{5mm}
{\normalsize A thesis submitted in partial fulfillment for the course}\\
{\normalsize PC4199 - \textit{Honours Project in Physics}}
}

\author{
{\normalsize Name \hspace{10mm} Matric Num}\\
\vspace{1mm}
{\normalsize Supervisor: Professor }\\
